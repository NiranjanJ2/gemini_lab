...
def main():
    ...
    create_parser.add_argument("--user-id", type=int, default=1, help="The user ID for the post.")
    ...
    update_parser.add_argument("--title", help="The new title for the post.")
    update_parser.add_argument("--body", help="The new body for the post.")
    ...
    list_parser.add_argument("--limit", type=int, default=10, help="The number of posts to list.")
    ...
    if args.command == "create":
        post = client.create_post(args.title, args.body, args.user_id)
        ...
        if updates:
            post = client.update_post(args.post_id, updates)
            print(json.dumps(post, indent=2))
        else:
            print("No updates specified. Use --title or --body to specify updates.")
