...
class PostAPIClient:
    ...
    def get_user_posts(self, user_id: int) -> List[Dict]:
        ...
        Returns:
            List of post dictionaries
        """
        endpoint = f"{API_BASE_URL}/users/{user_id}/posts"
        ...
        try:
            ...
            logger.error(f"Failed to get user posts: {str(e)}")
            raise
