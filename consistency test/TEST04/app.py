...
def main():
    ...
    parser = argparse.ArgumentParser(description='Post API Client CLI')
    ...
    create_parser.add_argument('--body', required=True, help='Post content')
    create_parser.add_argument('--user-id', type=int, default=1, help='User ID')

    # Get post command
    get_parser = subparsers.add_parser('get', help='Get a post by ID')
    get_parser.add_argument('post_id', type=int, help='Post ID')

    # Update post command
    update_parser = subparsers.add_parser('update', help='Update a post')
    update_parser.add_argument('post_id', type=int, help='Post ID')
    update_parser.add_argument('--title', help='New post title')
    update_parser.add_argument('--body', help='New post content')

    # Delete post command
    delete_parser = subparsers.add_parser('delete', help='Delete a post by ID')
    delete_parser.add_argument('post_id', type=int, help='Post ID')

    # List posts command
    list_parser = subparsers.add_parser('list', help='List posts')
    list_parser.add_argument('--limit', type=int, default=10, help='Number of posts to retrieve')

    # Get comments command
    comments_parser = subparsers.add_parser('comments', help='Get comments for a post')
    comments_parser.add_argument('post_id', type=int, help='Post ID')
